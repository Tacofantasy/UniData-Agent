...
package com.melody.ai.unidata.framework.idempotent;
...
public final class IdempotentSubmitAspect {
    ...
    @Value("${unidata.eval.enabled:false}")
    private boolean evalEnabled;

    /**
     * 增强方法标记 {@link IdempotentSubmit} 注解逻辑
     */
    @Around("@annotation(com.melody.ai.unidata.framework.idempotent.IdempotentSubmit)")
