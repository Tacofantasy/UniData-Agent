...
package com.melody.ai.unidata.user.service.impl;
...
import com.melody.ai.unidata.user.controller.request.ChangePasswordRequest;
import com.melody.ai.unidata.user.controller.request.UserCreateRequest;
import com.melody.ai.unidata.user.controller.request.UserPageRequest;
import com.melody.ai.unidata.user.controller.request.UserUpdateRequest;
import com.melody.ai.unidata.user.controller.vo.UserVO;
import com.melody.ai.unidata.user.dao.entity.UserDO;
import com.melody.ai.unidata.user.dao.mapper.UserMapper;
import com.melody.ai.unidata.user.enums.UserRole;
import com.melody.ai.unidata.user.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    @LogRecord(
            ...
            type = BizChangeBizType.USER,
            subType = BizChangeOperationType.UPDATE,
            bizNo = "{{T(com.melody.ai.unidata.framework.context.UserContext).getUserId()}}",
            extra = BizChangeLogContext.SNAPSHOT_EXPRESSION,
            condition = BizChangeLogContext.RECORD_CONDITION
    )
