...
package com.melody.ai.unidata.knowledge.service.impl;
...
import com.melody.ai.unidata.audit.constant.BizChangeBizType;
import com.melody.ai.unidata.audit.constant.BizChangeOperationType;
import com.melody.ai.unidata.audit.support.BizChangeLogContext;
import com.melody.ai.unidata.core.chunk.model.EmbeddedChunk;
import com.melody.ai.unidata.core.ingest.DocumentRef;
import com.melody.ai.unidata.core.ingest.IngestionKernel;
import com.melody.ai.unidata.core.ingest.IngestionOutcome;
import com.melody.ai.unidata.core.ingest.IngestionSpec;
import com.melody.ai.unidata.core.ingest.VectorTarget;
import com.melody.ai.unidata.core.ingest.sink.ChunkIndexWriter;
import com.melody.ai.unidata.core.parser.registry.ParserRegistry;
import com.melody.ai.unidata.framework.context.UserContext;
import com.melody.ai.unidata.framework.exception.ClientException;
import com.melody.ai.unidata.framework.exception.ServiceException;
import com.melody.ai.unidata.framework.mq.producer.MessageQueueProducer;
import com.melody.ai.unidata.ingestion.dao.entity.IngestionPipelineDO;
import com.melody.ai.unidata.ingestion.dao.mapper.IngestionPipelineMapper;
import com.melody.ai.unidata.ingestion.domain.context.IngestionContext;
import com.melody.ai.unidata.ingestion.domain.pipeline.PipelineDefinition;
import com.melody.ai.unidata.ingestion.engine.IngestionEngine;
import com.melody.ai.unidata.ingestion.service.IngestionPipelineService;
import com.melody.ai.unidata.knowledge.config.KnowledgeScheduleProperties;
import com.melody.ai.unidata.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.melody.ai.unidata.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.melody.ai.unidata.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.melody.ai.unidata.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.melody.ai.unidata.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.melody.ai.unidata.knowledge.controller.vo.KnowledgeDocumentVO;
import com.melody.ai.unidata.knowledge.dao.entity.KnowledgeBaseDO;
import com.melody.ai.unidata.knowledge.dao.entity.KnowledgeChunkDO;
import com.melody.ai.unidata.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
import com.melody.ai.unidata.knowledge.dao.entity.KnowledgeDocumentDO;
import com.melody.ai.unidata.knowledge.dao.mapper.KnowledgeBaseMapper;
import com.melody.ai.unidata.knowledge.dao.mapper.KnowledgeChunkMapper;
import com.melody.ai.unidata.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.melody.ai.unidata.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.melody.ai.unidata.knowledge.enums.DocumentStatus;
import com.melody.ai.unidata.knowledge.enums.ProcessMode;
import com.melody.ai.unidata.knowledge.enums.SourceType;
import com.melody.ai.unidata.knowledge.handler.RemoteFileFetcher;
import com.melody.ai.unidata.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.melody.ai.unidata.knowledge.schedule.CronScheduleHelper;
import com.melody.ai.unidata.knowledge.service.KnowledgeChunkService;
import com.melody.ai.unidata.knowledge.service.KnowledgeDocumentScheduleService;
import com.melody.ai.unidata.knowledge.service.KnowledgeDocumentService;
import com.melody.ai.unidata.knowledge.support.IngestionSpecCodec;
import com.melody.ai.unidata.knowledge.support.VectorTargetResolver;
import com.melody.ai.unidata.rag.core.vector.VectorSpaceId;
import com.melody.ai.unidata.rag.core.vector.VectorStoreService;
import com.melody.ai.unidata.rag.dto.StoredFileDTO;
import com.melody.ai.unidata.rag.service.FileStorageService;
import com.melody.ai.unidata.rag.util.DisplayType;
